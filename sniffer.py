...
def main():
    ...
    while True:
        ...
        print("\nEthernet Frame:")
        print(TAB_1 + "Destination: {} Source: {} Proto: {}".format(dest_mac, src_mac, eth_proto))
        ...
        if eth_proto == 8:
            ...
            # TCP
                ...
                (src_port, dest_port, sequence, acknowledge, flag_urg, flag_ack, flag_psh, flag_rst, flag_syn, flag_fin, data) = tcp_packet(data)
                print(TAB_1 + 'TCP Segment:')
                print(TAB_2 + 'Source Port: {}, Destination Port: {}'.format(src_port, dest_port))
                print(TAB_2 + 'Sequence: {}, Acknowledge: {}'.format(sequence, acknowledge))
                print(TAB_2 + 'Flags:')
